...
export const alt = "Technology Services in Nigeria | Harzotech";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ color: "white", fontSize: 52, fontWeight: 800, lineHeight: 1.15, letterSpacing: "-0.02em", maxWidth: 860 }}>
          ...
          <div style={{ color: "rgba(148,163,184,0.9)", fontSize: 20, lineHeight: 1.5, maxWidth: 700 }}>
            End-to-end technology services built to help Nigerian businesses grow faster.
          </div>
        </div>
