...
export const alt = "SEO & Digital Marketing Agency in Lagos, Nigeria — Google Rankings & Leads | Harzotech";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: "absolute", top: -60, right: -60, width: 420, height: 420, borderRadius: "50%", background: "radial-gradient(circle, rgba(21,101,192,0.38) 0%, transparent 70%)" }} />
        <div style={{ position: "absolute", bottom: -80, left: 80, width: 360, height: 360, borderRadius: "50%", background: "radial-gradient(circle, rgba(74,222,128,0.12) 0%, transparent 70%)" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ color: "white", fontSize: 52, fontWeight: 800, lineHeight: 1.15, letterSpacing: "-0.02em", maxWidth: 800 }}>
            Get Found on Google. <span style={{ color: "#86efac" }}>Rank Higher.</span>{" "}
            <span style={{ color: "#f87171" }}>Convert More.</span>
          </div>
          <div style={{ color: "rgba(148,163,184,0.9)", fontSize: 20, lineHeight: 1.5, maxWidth: 640 }}>
            Technical SEO, local SEO & lead generation for Nigerian businesses.
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <span style={{ color: "rgba(148,163,184,0.5)", fontSize: 13 }}>harzotech.com</span>
        </div>
      </div>
    ),
    { ...size }
