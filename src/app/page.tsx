...
const processSteps = [
  {
    ...
    description:
      "We understand your business, audience, goals, challenges, and the result you want to achieve.",
  },
  {
    title: "Planning & Structure",
    description:
      "We define the user journey, content structure, features, technology stack, and project direction.",
  },
  {
    title: "Design & Development",
    description:
      "We create a premium, responsive, functional, and scalable digital solution.",
  },
  {
    title: "Testing & Optimization",
    description:
      "We test usability, responsiveness, performance, SEO, security, and functionality.",
  },
  {
    title: "Launch & Support",
    description:
      "We deploy the project and provide post-launch support, maintenance, improvements, and technical guidance.",
  },
] as const;
    ...
    <div>
      ...
      <Section variant="dark" className="relative overflow-hidden py-24 sm:py-28">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_55%_at_50%_-5%,rgba(34,211,238,0.14),transparent),radial-gradient(ellipse_55%_45%_at_85%_105%,rgba(59,130,246,0.12),transparent)]" />
          <div className="absolute inset-0 opacity-[0.055] [background-image:radial-gradient(rgba(255,255,255,0.75)_1px,transparent_1px)] [background-size:30px_30px]" />
          <div className="absolute -top-40 left-1/3 h-[28rem] w-[28rem] rounded-full bg-cyan-500/[0.07] blur-3xl" />
          <div className="absolute -bottom-28 right-1/4 h-80 w-80 rounded-full bg-blue-600/[0.08] blur-3xl" />
        </div>
          ...
          <div className="relative grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-300">
                Harzotech builds premium websites, custom software, AI automation
                systems, SEO visibility, and digital growth engines — so your
                business works smarter and scales faster.
              </p>
            ...
            <div className="relative lg:pl-4">
              <div className="pointer-events-none absolute -inset-6 rounded-3xl bg-gradient-to-br from-cyan-500/10 via-transparent to-blue-600/10 blur-2xl" />

              <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 to-slate-950 p-6 shadow-2xl ring-1 ring-white/[0.06]">
                {/* Card header */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-emerald-400 shadow-[0_0_7px_rgba(52,211,153,0.9)]" />
                    <p className="text-sm font-semibold text-white">Business Growth Dashboard</p>
                  </div>
                  <span className="rounded-full border border-cyan-500/25 bg-cyan-500/10 px-2.5 py-0.5 text-[11px] font-medium text-cyan-300">
                    Live
                  </span>
                </div>
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  {[
                    { label: "Website Performance", value: "+38%", sub: "Conversion lift", color: "text-cyan-300" },
                    { label: "Lead Automation", value: "24/7", sub: "Response workflows", color: "text-blue-300" },
                  ].map((m) => (
                    <div key={m.label} className="rounded-2xl border border-white/[0.07] bg-white/[0.04] p-5">
                ...
                <div className="mt-4 rounded-2xl border border-white/[0.07] bg-white/[0.04] p-5">
                  <p className="text-xs font-medium text-slate-400">Operational Systems</p>
                  <div className="mt-4 grid grid-cols-3 gap-3">
                    {[
                      { label: "Bookings", value: "+12%", color: "text-cyan-300" },
                      { label: "Invoices", value: "Auto", color: "text-blue-300" },
                      { label: "Support", value: "SLA", color: "text-emerald-300" },
                    ].map((k) => (
                      <div key={k.label} className="rounded-xl border border-white/[0.07] bg-white/[0.05] p-3">
                        <p className="text-[11px] text-slate-400">{k.label}</p>
                        <p className={`mt-1.5 text-sm font-bold ${k.color}`}>{k.value}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {["Website", "Software", "AI / Automation", "SEO", "IT Support"].map((tag) => (
                    <span
                      key={tag}
        ...
        <Container>
          <div className="relative mx-auto max-w-4xl text-center">
            <div className="flex items-center justify-center gap-2.5">
              ...
              <p className="text-xs font-semibold tracking-[0.18em] uppercase text-cyan-600">
                Who We Are
              </p>
            </div>
            <h2 className="mt-4 text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">
              More Than an IT Company —{" "}
              <span className="text-cyan-700">A Digital Growth Partner</span>
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-slate-600">
              Harzotech combines technology, design, automation, SEO, software
              development, and business strategy to create digital solutions that
              solve real business problems — not just build websites.
            </p>
          </div>

          <div className="relative mt-14 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              { value: "10+", label: "Years Experience", color: "text-cyan-700" },
              { value: "50+", label: "Projects Delivered", color: "text-blue-700" },
              { value: "8+", label: "Industries Served", color: "text-violet-700" },
          ...
          <div className="relative grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-5 text-base leading-8 text-slate-600">
                Harzotech Nig Ltd is a privately owned technology solutions company
                helping businesses simplify operations, strengthen their digital
                presence, and scale through reliable digital systems.
              </p>

              <blockquote className="mt-7 rounded-2xl border-l-4 border-cyan-500 bg-white py-4 pl-5 pr-4 shadow-sm">
                <p className="text-sm leading-7 italic text-slate-700">
                  &ldquo;Technology should not just exist in a business. It should help the
                  business grow, operate better, and serve customers more
                  efficiently.&rdquo;
                </p>
                <footer className="mt-2 text-xs font-semibold text-slate-500">
                  — Azeez Agbona O., Founder
                </footer>
              </blockquote>

              <div className="mt-7">
                <ButtonLink href="/about" variant="secondary">
                  Learn More About Harzotech
                </ButtonLink>
              </div>
            </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                {services.slice(0, 6).map((s) => {
                  ...
                  return (
                    ...
                    >
                      <div className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-cyan-50 text-cyan-700">
      ...
      {/* 6. AI & Automation — dark */}
      <Section variant="dark" className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_20%_50%,rgba(34,211,238,0.09),transparent),radial-gradient(ellipse_50%_50%_at_85%_30%,rgba(59,130,246,0.09),transparent)]" />
        ...
        <Container>
          <div className="relative grid gap-14 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-8">
                <ButtonLink href="/ai-automation" variant="cta">
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <div className="p-5">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    >
                      <CheckCircle2 className="h-3.5 w-3.5 shrink-0 text-cyan-600" />
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="mt-5 text-base leading-8 text-slate-600">
                A website should build trust, explain your offer clearly, guide users
                to take action, and support your business goals. Harzotech builds
                with structure, SEO, performance, responsiveness, conversion, and
                brand credibility in mind.
              </p>
              <div className="mt-8">
                <ButtonLink href="/website-development" variant="secondary">
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-5 text-base leading-8 text-slate-600">
                Harzotech develops software systems that help businesses manage
                operations, customers, sales, inventory, bookings, payments, staff,
                and reporting from one reliable platform.
              </p>
              <div className="mt-8">
                <ButtonLink href="/software-development" variant="secondary">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div
                      ...
                      className="flex items-center gap-2 rounded-lg border border-slate-100 bg-slate-50 px-3 py-2.5"
                    >
                      <Code2 className="h-3.5 w-3.5 shrink-0 text-violet-600" />
                      <p className="text-xs font-medium text-slate-700">{item}</p>
                    </div>
                  ))}
                </div>
      ...
      {/* 9. Why Choose — numbered ghost cards */}
      <Section>
        <Container>
          <SectionHeading
            ...
            {whyChoose.map((w, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative inline-flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-50 text-cyan-700">
                    <Icon className="h-5 w-5" />
                  </div>
                  <p className="relative mt-4 text-sm font-semibold leading-6 text-slate-950">
                    {w.title}
                  </p>
                </div>
              );
      ...
      {/* 10. Process — dark with numbered circles */}
      <Section variant="dark" className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_100%,rgba(34,211,238,0.07),transparent)]" />
        <div className="pointer-events-none absolute inset-0 opacity-[0.04] [background-image:radial-gradient(rgba(255,255,255,0.7)_1px,transparent_1px)] [background-size:28px_28px]" />
        <Container>
              ...
              <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
                {processSteps.map((s, idx) => (
                  <div key={s.title} className="flex flex-col items-center text-center">
                    <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-full border border-cyan-500/30 bg-gradient-to-br from-cyan-500/20 to-blue-500/10 text-2xl font-black text-cyan-300">
                      {idx + 1}
                    </div>
                    <div className="mt-5">
        ...
        <Container>
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-5 text-base leading-8 text-slate-600">
                {`Harzotech is led by ${site.founder.name}, an IT specialist, developer, AI enthusiast, and digital strategist with over 10 years of experience helping businesses use technology to improve visibility, operations, customer experience, and growth.`}
              </p>
              <div className="relative mt-7 rounded-2xl border border-slate-200 bg-slate-50 p-6">
                <div className="pointer-events-none absolute -top-5 left-5 select-none text-6xl font-black leading-none text-cyan-100">
                  &ldquo;
                </div>
                <p className="relative text-sm leading-7 italic text-slate-700">
                  {site.founder.quote}
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div
                className="flex aspect-[4/3] w-full items-center justify-center rounded-2xl bg-gradient-to-br from-slate-100 via-cyan-50 to-slate-100"
                aria-label="Founder image placeholder"
                role="img"
              >
                <div className="flex h-24 w-24 items-center justify-center rounded-full border border-cyan-200 bg-gradient-to-br from-cyan-100 to-blue-100">
                  <p className="text-3xl font-black text-cyan-700">A</p>
                </div>
              </div>
              <div className="mt-5">
      ...
      <Section variant="dark" className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_50%_0%,rgba(34,211,238,0.08),transparent),radial-gradient(ellipse_50%_50%_at_80%_100%,rgba(59,130,246,0.08),transparent)]" />
        <div className="pointer-events-none absolute inset-0 opacity-[0.04] [background-image:radial-gradient(rgba(255,255,255,0.7)_1px,transparent_1px)] [background-size:28px_28px]" />
        <Container>
          <div className="relative">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {testimonials.map((t, idx) => (
                ...
                >
                  <div className="pointer-events-none absolute right-5 top-3 select-none text-7xl font-black leading-none text-white/[0.04]">
                    &ldquo;
                  </div>
                  ...
                  <div className="mt-6 flex items-center gap-3 border-t border-white/[0.07] pt-5">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-white/10 bg-gradient-to-br from-cyan-500/30 to-blue-500/30 text-xs font-bold text-cyan-300">
                      {t.name[0]}
                    </div>
                    <div>
      ...
      {/* 14. Final CTA */}
      <Section variant="dark" className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 opacity-55 bg-[radial-gradient(ellipse_at_top,rgba(34,211,238,0.18),transparent_55%),radial-gradient(ellipse_at_bottom,rgba(59,130,246,0.14),transparent_55%)]" />
        <Container>
          <div className="relative rounded-3xl border border-white/10 bg-white/5 p-10">
            <div className="flex items-center gap-2.5">
              <div className="h-3.5 w-0.5 rounded-full bg-cyan-400" />
            ...
            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-300">
              Whether you need a premium website, custom software, AI automation, IT
              support, SEO, or a complete digital growth system, Harzotech can help
              you build it with strategy, clarity, and excellence.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <ButtonLink href="/contact?intent=start-project" variant="cta">
                Start a Project →
