...
export const alt = "About Harzotech | Nigeria's Technology & Business Growth Partner";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18, zIndex: 1 }}>
          <div style={{ color: "white", fontSize: 52, fontWeight: 800, lineHeight: 1.15, letterSpacing: "-0.02em", maxWidth: 820 }}>
            Nigeria&apos;s Technology &amp; Business{" "}
            <span style={{ color: "#60a5fa" }}>Growth Partner</span>
          </div>
          <div style={{ color: "rgba(148,163,184,0.9)", fontSize: 20, lineHeight: 1.5, maxWidth: 680 }}>
            Founded 2014 · Lekki, Lagos, Nigeria · 10+ years · 50+ projects delivered across Africa.
          </div>
        </div>
