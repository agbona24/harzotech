...
export const alt = "Data Migration Services in Nigeria — Spreadsheet, Legacy System & Cloud Migration | Harzotech";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ color: "white", fontSize: 52, fontWeight: 800, lineHeight: 1.15, letterSpacing: "-0.02em", maxWidth: 780 }}>
            Move Your Data.{" "}
            <span style={{ color: "#60a5fa" }}>Lose Nothing.</span>{" "}
            <span style={{ color: "#f87171" }}>Start Fresh.</span>
          </div>
          <div style={{ color: "rgba(148,163,184,0.9)", fontSize: 20, lineHeight: 1.5, maxWidth: 640 }}>
            Spreadsheets, legacy systems & cloud migration — built for Nigeria.
          </div>
        </div>
